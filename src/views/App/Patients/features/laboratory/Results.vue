<template>
  <b-container fluid>
    <b-modal id="modal-1-results" ref="modal-1-results" title="Agregar">
    ...
    <b-modal id="modal-2-results" ref="modal-2-results" title="Editar">
      <b-alert
        :show="alertCountDownError"
        dismissible
        fade
    ...
    <b-modal id="modal-3-results" ref="modal-3-results" title="Desactivar">
      <h6 class="my-4">
      ...
      <template #modal-footer="{}">
        <b-button
          ...
          variant="primary"
          @click="onState()
          $bvModal.hide('modal-3-results')"
          >Desactivar</b-button
        >
        <b-button variant="danger" @click="$bvModal.hide('modal-3-results')"
          >Cancelar</b-button
        >
      </template>
    </b-modal>
    <b-modal id="modal-4-results" ref="modal-4-results" title="Activar">
      <h6 class="my-4">
      ...
      <template #modal-footer="{}">
        <b-button
          ...
          >Activar</b-button
        >
        <b-button variant="danger" @click="$bvModal.hide('modal-4-results')"
          >Cancelar</b-button
        >
      </template>
    </b-modal>
      ...
      <b-col md="12">
        <iq-card>
            <template v-slot:headerTitle>
              <h4 class="card-title mt-3">Resultados</h4>
            ...
            <b-button variant="primary"  v-b-modal.modal-1-results>AGREGAR RESULTADO</b-button>
          </template>
                ...
                <b-button
                  @click="
                    ...
                    props.rowData.estado == 1
                      ? $bvModal.show('modal-3-results')
                      : $bvModal.show('modal-4-results');
                  "
                  class="mb-2"
                  :variant="
  ...
  methods: {
    ...
    closeModal (action) {
      switch (action) {
        case 'save': {
          this.$v.$reset()
          this.$refs['modal-1-results'].hide()
        ...
        case 'update': {
          this.$v.$reset()
          this.$refs['modal-2-results'].hide()
          // Aqui agregar variables
          this.form.id = 0
          this.form.tipo.nombre = ''
          this.form.estado_diagnostico.nombre = ''
