      ...
      <b-col md="12">
        <iq-card>
            <template v-slot:headerTitle>
              <h4 class="card-title mt-3">Ventas de Inventario</h4>
            ...
            <b-button variant="primary"  v-b-modal.modal-1>Estamos Trabajando en ello</b-button>
          </template> -->
          <template v-slot:body>
            <h3>Seguimos trabajando en este modulo, disculpa las molestias.</h3>
            <!-- <datatable-heading
