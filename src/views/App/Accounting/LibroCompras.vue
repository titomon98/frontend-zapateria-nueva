...
export default {
  ...
  data () {
    return {
      ...
      alertErrorText: '',
      alertVariant: '',
      apiBase: apiUrl + '/libros/compras/list',
      fields: [
        {
          name: 'descripcion',
  ...
  methods: {
    ...
    EXCEL () {
      ...
      worksheet.addRow(['FECHA', 'DOCUMENTO', '', 'PROVEEDOR/PRESTADOR', '', 'COMPRAS-SERVICIOS PEQUEÑO CONTRIBUYENTE', 'COMPRAS-SERVICIOS RÉGIMEN GENERAL', 'PRECIOS BASE', '', '', 'ISR/COMPRAS-SERVICIOS', 'IVA CREDITO FISCAL', 'TOTALES'])
      worksheet.addRow(['', 'TIPO', 'NÚMERO', 'NIT O DPI', 'NOMBRE', 'TOTAL FACTURA', 'TOTAL FACTURA', 'COMPRAS', 'SERVICIOS', 'IMPORTACIÓN', 'ISR', '', ''])
      // aqui añadir los datos
      worksheet.addRow(['', '', '', '', 'TOTALES', 'Q 0.0', 'Q 0.0', 'Q 0.0', 'Q 0.0', 'Q 0.0', 'Q 0.0', 'Q 0.0', 'Q 0.0'])
      worksheet.addRow(['', '', '', '', '', 'COMPRAS-SERVICIOS PEQUEÑO CONTRIBUYENTE', 'COMPRAS-SERVICIOS RÉGIMEN GENERAL', 'COMPRAS', 'SERVICIOS', 'IMPORTACIÓN', 'ISR S/COMPRAS-SERVICIOS', 'IVA CRÉDITO FISCAL', 'TOTALES'])
