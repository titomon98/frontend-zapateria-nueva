...
export default {
  ...
  data () {
    return {
      ...
      alertErrorText: '',
      alertVariant: '',
      apiBase: apiUrl + '/libros/ventas/list',
      fields: [
        {
          name: 'descripcion',
  ...
  methods: {
    ...
    EXCEL () {
      ...
      worksheet.addRow(['', '', '', '', 'TOTALES', 'Q 0.0', 'Q 0.0', 'Q 0.0', 'Q 0.0', 'Q 0.0', 'Q 0.0'])
      worksheet.addRow(['', '', '', '', '', 'TOTAL FACTURA VENTA/SERVICIO', 'VENTA', 'SERVICIO', 'ISR S/VENTAS', 'IVA DÉBITO FISCAL', 'TOTALES'])
